...
import com.liaojiexin.netty23.c10.protocol.MessageCodec;
...
public class TestMessageCodec {
    ...
    public static void main(String[] args) throws Exception {
         ...
         * |00000110| 61 6e                                           |an              |
         * +--------+-------------------------------------------------+----------------+
         * 16:51:42.165 [main] DEBUG com.liaojiexin.netty23.c10.protocol.MessageCodec - 获取到解码后的信息[魔数:16909060,版本号:1,序列化方法:0,指令类型:0,请求序号:0,内容长度:258,内容:LoginRequestMessage(super=com.liaojiexin.netty23.c9.message.LoginRequestMessage@d3114751, username=zhangsan, password=123456, nickname=张三)]
         ...
         * +--------+-------------------------------------------------+----------------+
         * 17:09:13.791 [main] DEBUG com.liaojiexin.netty23.c10.protocol.MessageCodec - 获取到解码后的信息[魔数:16909060,版本号:1,序列化方法:0,指令类型:0,请求序号:0,内容长度:258,
         * 内容:LoginRequestMessage(super=com.liaojiexin.netty23.c10.message.LoginRequestMessage@d3114751, username=zhangsan, password=123456, nickname=张三)]
         */
    }
}
